...
def subSetTreeFile(suffix,cloud1,cloud2,cloud3,cloud4,ratioName):
	for t in glob.glob(suffix):
		...
		# Print out info 
		print(newName)
		print("originalSize, secondStart, secondCloud, thirdStart, thirdCloud, fourthStart, fourthCloud")
		print(originalSize, secondStart, secondCloud, thirdStart, thirdCloud, fourthStart, fourthCloud)
...
cloud3=833
cloud4=833
subSetTreeFile(suffix,cloud1,cloud2,cloud3,cloud4,ratioName)
