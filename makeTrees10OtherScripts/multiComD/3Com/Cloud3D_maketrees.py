...
def makeStarting(tips,RF_norm_start_far,RF_norm_start,name,RF_norm_cloud,cloud_size):
	...
	# Make third tree that is different distance from t2
	t3 = readTree.NNI_mult_moves(in_tree=t1,num_moves=NNI_moves_start_far,node_choice='random',no_dup_start_tree='F', req_min_RF=RF_norm_start_far)
