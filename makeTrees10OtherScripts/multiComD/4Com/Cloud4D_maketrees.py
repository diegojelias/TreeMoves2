...
def makeStarting(tips,RF_norm_start_far,RF_norm_start,name,RF_norm_cloud,cloud_size):
	...
	t4 = readTree.NNI_mult_moves(in_tree=t1,num_moves=NNI_moves_start_far,node_choice='random',no_dup_start_tree='F', req_min_RF=RF_norm_start_far)
	...
	while round(d24, 2) != RF_norm_start_far or round(d34, 2) != RF_norm_start_far:
