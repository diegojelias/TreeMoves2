...
def subSetTreeFile(suffix,cloud1,cloud2,cloud3,cloud4,cloud5,ratioName):
	for t in glob.glob(suffix):
		...
		# Fourth
		fourthStart = thirdStart + originalSize
		fourthCloud = fourthStart + cloud4
		# Fifth
		fifthStart = fourthStart + originalSize
		fifthCloud = fifthStart + cloud5
		# Print out info 
		print(newName)
		print("originalSize, secondStart, secondCloud, thirdStart, thirdCloud, fourthStart, fourthCloud, fifthStart, fifthCloud")
		print(originalSize, secondStart, secondCloud, thirdStart, thirdCloud, fourthStart, fourthCloud, fifthStart, fifthCloud)
		...
		with open(t, 'r') as nexus:
			for i, line in enumerate(nexus):
				if i < firstCloud:
					...
					#print(line)
					outFile.write(line)
				elif fourthCloud > i >= fourthStart:
					#print(line)
					outFile.write(line)
				elif fifthCloud > i >= fifthStart:
					#print(line)
					outFile.write(line)
			outFile.write("End;")
		outFile.close()
...
cloud4=833
cloud5=833
subSetTreeFile(suffix,cloud1,cloud2,cloud3,cloud4,cloud5,ratioName)
